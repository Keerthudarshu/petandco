...
const slides = [
  {
    src: '/assets/images/banners/dog.png',
  ...
  {
    src: '/assets/images/banners/meowsi_web.png',
  ...
  {
    src: '/assets/images/banners/Winter_25_web.png',
...
const HeroSlider = ({ interval = 4000, transition = 1000 }) => {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative w-full max-w-full overflow-hidden ${isMobile ? 'px-4' : 'mx-0 px-0 h-screen'}`}
      style={{ height: isMobile ? '240px' : undefined }}
            ...
            <div className="w-full h-full flex items-center justify-center">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: `url('${encodeURI(isMobile && s.mobileSrc ? s.mobileSrc : s.src)}')`,
                    backgroundSize: 'cover',
                    backgroundPosition: s.position || 'center',
                    transformOrigin: 'center center',
                    animation: active ? `ksKenBurns ${interval + transition}ms ease-in-out forwards` : 'none'
                  }}
                />
              </div>
            </div>

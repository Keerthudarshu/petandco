...
const categories = [
  { id: 'all', label: 'All Dog Health & Hygiene', img: '/assets/images/health/all-health.webp' },
  { id: 'oral-care', label: 'Oral Care', img: '/assets/images/health/oral-care.webp' },
  { id: 'supplements', label: 'Supplements', img: '/assets/images/health/supplements.webp' },
  { id: 'tick-flea-control', label: 'Tick & Flea Control', img: '/assets/images/health/tick-flea.webp' }
];

const sampleProducts = [
  { id: 'hh1', name: 'Dog Toothpaste & Brush Set', image: '/assets/images/health/toothpaste.webp', badges: ['Vet Recommended'], variants: ['One Size'], price: 249 },
  { id: 'hh2', name: 'Joint Supplement Chews', image: '/assets/images/health/supplement.webp', badges: ['Top Rated'], variants: ['60 Chews'], price: 899 },
  { id: 'hh3', name: 'Tick & Flea Spot-on', image: '/assets/images/health/tick-flea-product.webp', badges: ['Fast Acting'], variants: ['Small','Medium','Large'], price: 599 }
];

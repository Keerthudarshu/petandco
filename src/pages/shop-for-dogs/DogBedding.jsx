...
const categories = [
  { id: 'beds', label: 'Beds', img: '/assets/images/bedding/beds.webp' },
  { id: 'blankets-cushions', label: 'Blankets & Cushions', img: '/assets/images/bedding/blankets.webp' },
  { id: 'mats', label: 'Mats', img: '/assets/images/bedding/mats.webp' },
  { id: 'personalised-bedding', label: 'Personalised Bedding', img: '/assets/images/bedding/personalised.webp' },
  { id: 'tents', label: 'Tents', img: '/assets/images/bedding/tents.webp' },
  { id: 'all', label: 'All Dog Bedding', img: '/assets/images/bedding/all-bedding.webp' }
];
          ...
          <main ref={rightRef} onWheel={handleRightWheel} className="col-span-12 lg:col-span-9 xl:col-span-10" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 220px)' }}>
            <div className="mb-4">
              <div className="inline-flex items-center gap-2">
                {['Material','Size','Washable','Price'].map(t => (

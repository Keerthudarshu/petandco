...
const Footer = () => {
  ...
  const features = [
    { title: 'By creating innovative products & services', link: 'Explore HUFT Innovations', icon: 'Rocket' },
    { title: 'By becoming your pet-parenting partners', link: 'Follow us on instagram', icon: 'Shield' },
    { title: 'By building the foundation for a kinder world', link: 'View HUFT Foundation Initiatives', icon: 'Home' },
    { title: 'By helping animals in need with every order', link: 'Feed A Dog In Need', icon: 'Heart' },
    { title: 'By fostering a community for animal enthusiasts', link: 'Join HUFT Tribe', icon: 'MessageCircle' }
  ];
    ...
    <footer className="bg-[#071322] text-white">
      ...
      <div className="border-b border-[#0f2230]">
        <div className="container mx-auto px-4 py-6 flex items-center justify-between">
          ...
          <div className="flex-1 text-center px-6 text-sm text-gray-200">
            We’re truly honoured to announce that HUFT has been crowned with World Branding Award: Brand Of The Year for an unprecedented fifth year in a row, and World Branding Award: Treats Of The Year. Thank you for returning our love for pets with more love, trust, and support.
          </div>
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          {/* House of HUFT */}
          <div>
            <h5 className="font-semibold mb-4">House of HUFT</h5>
            <ul className="space-y-2 text-sm text-gray-200">
              <li>Sara's</li>
              <li>Sara's Treats</li>
              <li>Meowsi</li>
          ...
          <div className="md:col-span-1">
            <h5 className="font-semibold mb-4">The World of HUFT</h5>
            <ul className="space-y-2 text-sm text-gray-200">
              <li>About Us</li>
              <li>Careers</li>
              <li>Awards</li>
          ...
          {/* Newsletter / Join the HUFT Family */}
          <div>
            <h5 className="font-semibold mb-4">Join the HUFT Family</h5>
